...
const sponser = () => {
    ...
    <>
      ...
      <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Ttile Sponsered By</h2>
        <div class="container mx-auto flex px-2 py-2 items-center justify-center flex-col">
          <img class="lg:w-2/6 md:w-3/6 w-5/6  object-cover object-center rounded" alt="hero" src={process.env.PUBLIC_URL + ' /images/Coca-Cola-Logo.png'}/>
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="grid grid-cols-2 gap-26 rounded-lg bg-gray-100 p-6 sm:h-40 sm:content-evenly md:grid-cols-4">
            ...
            <img alt="testimonial" class=" object-cover object-center  inline-block  border-gray-200 bg-gray-100" src={process.env.PUBLIC_URL + ' /images/Coca-Cola-Logo.png'}></img>
            </div>
     
            <div class="flex justify-center text-gray-400">
            <img alt="testimonial" class=" object-cover object-center  inline-block  border-gray-200 bg-gray-100" src={process.env.PUBLIC_URL + ' /images/Unacademy-logo.png'}></img>
            </div>
