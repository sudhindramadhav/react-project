    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 md:w-1/2 w-full">
        <div class="h-full bg-gray-100 p-8 rounded">
          ...
          <p class="leading-relaxed mb-6 text-justify">This event is not just a gathering; it is a testament to our shared values of excellence, collaboration, and celebration.
...
Let us approach this event with enthusiasm and a commitment to showcase the best of who we are. Together, we will create an experience that reflects our collective efforts and achievements. I look forward to seeing our community come together in unity and joy.</p>
          <a href="|" class="inline-flex items-center">
            ...
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900">Mr. N Sudhakar Reddy</span>
              <span class="text-gray-500 text-sm">Principal</span>
            </span>
          </a>
        </div>
      </div>
      <div class="p-4 md:w-1/2 w-full">
        <div class="h-full bg-gray-100 p-8 rounded">
          ...
          <p class="leading-relaxed mb-6 text-justify">It is a testament to our shared values of collaboration, innovation, and celebration.

Let us approach this event with enthusiasm and a commitment to showcase the best of who we are. Together, we will create an experience that reflects our unity, diversity, and the strength of our community.

I am excited to see us come together to celebrate our achievements and inspire each other to greater heights.</p>
          <a href="|" class="inline-flex items-center">

            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900">Mr. Prakash Ambavaram </span>
              <span class="text-gray-500 text-sm">Vice Chairman</span>
            </span>
          </a>
        </div>
      </div>
