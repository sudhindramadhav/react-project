  ...
  return (
    <>
        ...
        <div class="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
            ...
            <img class="object-cover object-center rounded" alt="hero" src={process.env.PUBLIC_URL + '/images/periodpain.jpg'}/>
            </div>
            <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">PERIOD PAIN
            </h1>
