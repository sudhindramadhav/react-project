...
const sponser = () => {
  return (
    <>
      ...
      <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl mt-6">TITLE SPONSERED BY</h2>
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div class="mb-4 flex flex-col items-center md:mb-8 lg:flex-row lg:justify-between">
      <h2 class="mb-2 text-center text-2xl font-bold text-gray-800 lg:mb-0 lg:text-3xl">Sponsers</h2>
    </div>
