  ...
  <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div className="flex flex-col items-center border-t pt-6">
      ...
      <div className="flex gap-4">
        <a href="https://www.instagram.com/svcetirupati?igsh=YjlubjZ3cWFtZ2Vk"  className="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
        ...
        <a href="https://twitter.com/SVCE_Tirupati"  className="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
...
//             <nav className="mb-4 flex flex-wrap justify-center gap-x-4 gap-y-2 md:justify-start md:gap-6">
//               <Link to='/about' className="about text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">About</Link>
//               <Link to='/sponsors' className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Sponsors</Link>
//               <Link to='/events' className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Events</Link>
//               <Link to='/contact' className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Contact Us</Link>
//             </nav>
...
//             <iframe
//               title="map"
//               src="https://www.google.com/maps/search/svce+tirupati/@13.6449874,79.4482029,11.86z?entry=ttu"
//               width="300"
//               height="225"
//               style={{ border: 0 }}
//               allowFullScreen=""
//             ></iframe>
//             <br />
//             Copyright © sv colleges all rights are reserved <br />
//             <strong>DJ MURALI MAHESH</strong> || <strong>KKM SUDHINDRA</strong>
//           </div>
//         </footer>
//       </div>
//     </>
