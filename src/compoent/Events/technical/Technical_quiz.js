...
const Technical_quiz = () => {
  ...
  return (
    <>
        ...
        ◦ In case of tie between 2 or more teams, further 3 questions would be asked for final selection<br/>
    • Stage Rounds<br/>
    <strong className='text-red-500'>First Round (Lap Round)</strong><br/>
        ◦ 
            ...
            <strong className='text-red-500'>Second Round (Audio-visual round)</strong><br/>
        ...
        ◦ If a team cannot answer the question, than the question would be forwarded to the next team<br/>
        ◦ This round is not elimination round<br/>
        <strong className='text-red-500'>  Third Round (Picture Identify)</strong><br/>
        ...
        ◦ Answering time is only 30 seconds<br/>
        ◦ 3 teams are to be selected for the final round<br/>
    <strong className='text-red-500'>Final Round (Rapid Fire)</strong> <br/>
